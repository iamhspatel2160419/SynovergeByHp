...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if StorageManager.sharedHelper.isUserLoggedIn()
        {
    ...
    func deleteIterm()
    {
        ...
        let dbUrl = supportDirectory.appendingPathComponent("SynovergeByHp.sqlite")
        print("dbUrl",dbUrl)
        do {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        let modelURL = Bundle.main.url(forResource: "SynovergeByHp", withExtension: "momd")
        print(modelURL ?? "")
        return NSManagedObjectModel(contentsOf: modelURL!)!
    }()
    lazy var persistentContainer: NSPersistentContainer = {
        let container = NSPersistentContainer(name: "SynovergeByHp")
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let supportDirectory = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!
        let url = supportDirectory.appendingPathComponent("SynovergeByHp.sqlite")
        print(url)
